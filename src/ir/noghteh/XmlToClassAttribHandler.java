...
public class XmlToClassAttribHandler {
	...
	public String getTextValue() {
		...
		if (value.length() > 1 && value.charAt(0) == '@'
			...
			int resId = mRes.getIdentifier(mContext.getPackageName() + ":"
					+ value.substring(1), null, null);
	...
	public int getColorValue() {
		...
		String value = mAttributeSet.getAttributeValue(namespace,
				KEY_TEXT_COLOR);
	...
	public int getTextSize() {
		...
		String value = mAttributeSet
				.getAttributeValue(namespace, KEY_TEXT_SIZE);
