...
public class ActivityList5_1Clinic extends ExtendActivityWithUp {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity5_1clinic);
		setvalue(2);
		...
		btnResult.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent localIntentLock = new Intent(ActivityList5_1Clinic.this,
