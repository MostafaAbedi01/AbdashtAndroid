...
public class ActivityList2_11Motel extends ExtendActivityWithUp {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity2_11motel);
		...
		btnResult.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent localIntentLock = new Intent(ActivityList2_11Motel.this,
