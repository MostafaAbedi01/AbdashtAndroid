...
public class ActivityList9_6CampShower extends ExtendActivityWithUp {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity9_6campshower);
		...
		btnResult.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				StaticValue.LiterShowerCalc = (int) (countShower * 600);
				...
				Intent localIntentLock = new Intent(
						ActivityList9_6CampShower.this,
