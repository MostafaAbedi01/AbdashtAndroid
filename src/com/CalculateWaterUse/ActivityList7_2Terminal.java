...
public class ActivityList7_2Terminal extends ExtendActivityWithUp {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity7_2terminal);
		...
		btnResult.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				StaticValue.LiterShowerCalc = (int) (countShower * 5);
				StaticValue.LiterCalc = StaticValue.LiterShowerCalc;
				StaticValue.LiterMain = StaticValue.LiterShowerMain;
				Intent localIntentLock = new Intent(ActivityList7_2Terminal.this,
