...
public class ActivityList2_7Estakhr extends ExtendActivityWithUp {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity2_7estakhr);
		setvalue(2);
		...
		btnResult.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent localIntentLock = new Intent(ActivityList2_7Estakhr.this,
