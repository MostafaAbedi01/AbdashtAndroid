...
public class ActivityList3_2Cow extends ExtendActivityWithUp {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity3_2cow);
		...
		btnResult.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent localIntentLock = new Intent(ActivityList3_2Cow.this,
