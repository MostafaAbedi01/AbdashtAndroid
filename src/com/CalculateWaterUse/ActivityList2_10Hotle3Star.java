...
public class ActivityList2_10Hotle3Star extends ExtendActivityWithUp {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity2_10hotel3);
		...
		btnResult.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!valStr.equals(""))
					...
					Toast.makeText(ActivityList2_10Hotle3Star.this,
				...
				Intent localIntentLock = new Intent(ActivityList2_10Hotle3Star.this,
