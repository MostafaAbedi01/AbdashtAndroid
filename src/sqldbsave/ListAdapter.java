...
public class ListAdapter extends BaseAdapter {
	...
	public void setData(List<TblManhol> list) {
		this.list = list;
...
//		holder.tvName.setText(list.get(position).getRfid());
//		holder.tvPhone.setText(list.get(position).getcodepm());
